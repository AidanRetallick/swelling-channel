...
int main(int argc, char** argv)
{
  ...
  Parameters::n_long_edge_nodes = ceil(0.01 * Parameters::L1 / Parameters::Thickness) + 2;
  Parameters::n_short_edge_nodes = ceil(0.01 * Parameters::L2 / Parameters::Thickness) + 2;
